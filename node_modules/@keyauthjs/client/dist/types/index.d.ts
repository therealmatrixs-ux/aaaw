...
declare const KeyauthEventEmitter_base: new () => TypedEmitter<EventMap>;
export declare class KeyauthEventEmitter extends KeyauthEventEmitter_base {
    constructor();
}
export type EventType = "init" | "login" | "logout" | "register" | "license" | "fetchStats" | "ban" | "changeUsername" | "checkblacklist" | "check" | "file" | "fetchOnline" | "forgot" | "chatget" | "getvar" | "log" | "chatsend" | "setvar" | "upgrade" | "webhook" | "var" | "request" | "response" | "metadata" | "error" | "session" | "instance" | "ratelimit";
...
export type EventMap = {
    ...
    forgot: (data: ForgotPasswordResponse & {
        username: string;
    }) => void;
    chatget: (data: GetChatResponse) => void;
    getvar: (data: GetUserVarResponse) => void;
    log: (data: LogResponse & {
        msg: string;
        pcUser: string;
    }) => void;
    chatsend: (data: SendChatResponse & {
        sentMsg: string;
        author: String;
    }) => void;
    ...
    request: (data: RequestResponse<EventType> & {
        type: EventType;
    }) => void;
    response: (data: EventMap[EventType] & {
        type: EventType;
    }) => void;
    metadata: (data: BaseResponse & {
        metaData: METADATA;
    }) => void;
    error: (data: {
        success: false;
...
type Error_Code = "seesionKilled" | "noSessionID" | "notInitialized" | "notLoggedIn" | "unsupportedVarType" | "unknown" | "noChatChannel" | "invalidClientApi";
